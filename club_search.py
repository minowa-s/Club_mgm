...
def club_search_nolog():
    return render_template("club_search_nolog.html")
...
def club_search_nologres():
    ...
    return render_template("club_search_nologres.html", club=club_list)

#学生サークル検索
@club_search_bp.route("/club_search_stu")
def club_search_stu():
    return render_template("club_search_stu.html")
...
def club_search_resstu():
        ...
        introduction = name
        club_list = club_search(name,introduction)
        return render_template("club_search_resstu.html", club=club_list)

#サークルリーダーサークル検索
@club_search_bp.route("/club_search_lea")
def club_search_lea():
    return render_template("club_search_lea.html")
...
def club_search_reslea():
        ...
        introduction = name
        club_list = club_search(name,introduction)
        return render_template("club_search_reslea.html", club=club_list)

#学生会サークル検索
@club_search_bp.route("/club_search_cou")
def club_search_cou():
    return render_template("club_search_cou.html")
...
def club_search_rescou():
        ...
        introduction = name
        club_list = club_search(name,introduction)
        return render_template("club_search_rescou.html", club=club_list)

#教員用サークル検索    
@club_search_bp.route("/club_search_tea")
def club_search_tea():
    return render_template("club_search_tea.html")
...
def club_search_restea():
        ...
        introduction = name
        club_list = club_search(name,introduction)
        return render_template("club_search_restea.html", club=club_list)
